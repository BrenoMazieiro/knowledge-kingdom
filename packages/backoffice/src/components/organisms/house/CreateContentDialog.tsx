...
type CreateContentDialogProps = {
  ...
  onSubmit: (data: { title: string; type: string; url?: string; body?: string; description?: string }) => Promise<void>;
  loading: boolean;
};

export const CreateContentDialog = ({ open, onOpenChange, onSubmit, loading }: CreateContentDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Add new learning content to this house.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
